...
from networksecurity.entity.artifact_entity import (
    DataTransformationArtifact, DataValidationArtifacts
)
...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        """
        Initializes a KNNImputer object with the parameters specified in the training_pipeline.py file and
        ...
        try:
            ...
            if TARGET_COLUMN not in train_df.columns or TARGET_COLUMN not in test_df.columns:
                raise NetworkSecurityException(
                    f"Target column '{TARGET_COLUMN}' not found in train/test dataframes", sys
                )
