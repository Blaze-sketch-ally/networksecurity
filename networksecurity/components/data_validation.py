...
from scipy.stats import ks_2samp #checks 2 samples of data to give if there is a data drift or not
import pandas as pd
import os ,sys
...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            required_columns = self._schema_config["columns"]  # read list of columns from schema
    ...
    def initiate_data_validation(self) -> DataValidationArtifacts:
        try:
            error_message = ""   # Initialize first
